    ...
    <View style={styles.card}>
        <View style={styles.typeSelector}>
            ...
            onPress={()=> setIsExpense(true)}>
                ...
                <Text style={[styles.typeButtonText, isExpense && styles.typeButtonTextActive]}>Expense
          ...
          >
            ...
            <View style={styles.amountContainer}>
                ...
                <Text style={styles.sectionTitle}>
                    <Ionicons name='pricetag-outline' size={16} color={COLORS.text} /> Category </Text>
